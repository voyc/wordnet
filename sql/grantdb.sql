...
grant select,update on wn.pos_id_seq to voyccom_webuser64;

grant select,insert,update,delete on wn.ptr to voyccom_webuser64;
grant select,update on wn.ptr_id_seq to voyccom_webuser64;

grant select,insert,update,delete on wn.cat to voyccom_webuser64;
grant select,update on wn.cat_id_seq to voyccom_webuser64;
